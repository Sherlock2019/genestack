...
Generated: 2025-11-25 00:07:32

| Component | Type | Version in Repo | Latest Upstream Version | OpenStack Software Version | OpenStack Release Name | Compatibility | Recommended Upstream | Source Path | Notes |
|---|---|---|---|---|---|---|---|---|---|
...
| barbican | openstack-service | 2024.2.208+13651f45-628a320c | N/A | dalmatian v2.208 | Dalmatian | OK | dalmatian v2.208 | helm-chart-versions.yaml | OpenStack Helm chart version |
| blazar | openstack-service | 2025.1.3+95bf0bf6e | N/A | epoxy v1.3 | Epoxy | ❌ Mismatch | dalmatian v2.208 | helm-chart-versions.yaml | OpenStack Helm chart version |
| ceilometer | openstack-service | 2024.2.115+13651f45-628a320c | N/A | dalmatian v2.115 | Dalmatian | OK | dalmatian v2.115 | helm-chart-versions.yaml | OpenStack Helm chart version |
| cinder | openstack-service | 2024.2.409+13651f45-628a320c | N/A | dalmatian v2.409 | Dalmatian | OK | dalmatian v2.409 | helm-chart-versions.yaml | OpenStack Helm chart version |
| cloudkitty | openstack-service | 2025.1.2+ebb1488dc | N/A | epoxy v1.2 | Epoxy | ❌ Mismatch | dalmatian v2.208 | helm-chart-versions.yaml | OpenStack Helm chart version |
| freezer | openstack-service | 2025.1.2+cdd5c6c55 | N/A | epoxy v1.2 | Epoxy | ❌ Mismatch | dalmatian v2.208 | helm-chart-versions.yaml | OpenStack Helm chart version |
| glance | openstack-service | 2024.2.396+13651f45-628a320c | N/A | dalmatian v2.396 | Dalmatian | OK | dalmatian v2.396 | helm-chart-versions.yaml | OpenStack Helm chart version |
| gnocchi | openstack-service | 2024.2.52+22.15d38 | N/A | dalmatian v2.52 | Dalmatian | OK | dalmatian v2.52 | helm-chart-versions.yaml | OpenStack Helm chart version |
| heat | openstack-service | 2024.2.294+13651f45-628a320c | N/A | dalmatian v2.294 | Dalmatian | OK | dalmatian v2.294 | helm-chart-versions.yaml | OpenStack Helm chart version |
| horizon | openstack-service | 2024.2.264+13651f45-628a320c | N/A | dalmatian v2.264 | Dalmatian | OK | dalmatian v2.264 | helm-chart-versions.yaml | OpenStack Helm chart version |
| ironic | openstack-service | 2024.2.121+13651f45-628a320c | N/A | dalmatian v2.121 | Dalmatian | OK | dalmatian v2.121 | helm-chart-versions.yaml | OpenStack Helm chart version |
| keystone | openstack-service | 2024.2.386+13651f45-628a320c | N/A | dalmatian v2.386 | Dalmatian | OK | dalmatian v2.386 | helm-chart-versions.yaml | OpenStack Helm chart version |
| magnum | openstack-service | 2024.2.157+13651f45-628a320c | N/A | dalmatian v2.157 | Dalmatian | OK | dalmatian v2.157 | helm-chart-versions.yaml | OpenStack Helm chart version |
| masakari | openstack-service | 2024.2.17+13651f45-628a320c | N/A | dalmatian v2.17 | Dalmatian | OK | dalmatian v2.17 | helm-chart-versions.yaml | OpenStack Helm chart version |
| neutron | openstack-service | 2024.2.529+13651f45-628a320c | N/A | dalmatian v2.529 | Dalmatian | OK | dalmatian v2.529 | helm-chart-versions.yaml | OpenStack Helm chart version |
| nova | openstack-service | 2024.2.555+13651f45-628a320c | N/A | dalmatian v2.555 | Dalmatian | OK | dalmatian v2.555 | helm-chart-versions.yaml | OpenStack Helm chart version |
| octavia | openstack-service | 2025.1.15+b1e463122 | N/A | epoxy v1.15 | Epoxy | ❌ Mismatch | dalmatian v2.208 | helm-chart-versions.yaml | OpenStack Helm chart version |
| placement | openstack-service | 2024.2.62+13651f45-628a320c | N/A | dalmatian v2.62 | Dalmatian | OK | dalmatian v2.62 | helm-chart-versions.yaml | OpenStack Helm chart version |
...
| jsonschema-specifications | python-package | 2023.12.1 | 2025.9.1 | antelope v1 | Antelope | ❌ Mismatch | dalmatian v2.208 | dev-requirements.txt |  |
...
| heat | generic-image | 2024.1-latest" | N/A (requires registry access) | caracal v1 | Caracal | ❌ Mismatch | dalmatian v2.208 | base-kustomize/skyline/base/deployment-apiserver.yaml | Image: "ghcr.io/rackerlabs/genestack-images/heat |
...
| skyline | generic-image | 2024.2-latest" | N/A (requires registry access) | dalmatian v2 | Dalmatian | OK | dalmatian v2 | base-kustomize/skyline/base/deployment-apiserver.yaml | Image: "ghcr.io/rackerlabs/genestack-images/skyline |
| skyline | generic-image | 2024.2-latest" | N/A (requires registry access) | dalmatian v2 | Dalmatian | OK | dalmatian v2 | base-kustomize/skyline/base/deployment-apiserver.yaml | Image: "ghcr.io/rackerlabs/genestack-images/skyline |
